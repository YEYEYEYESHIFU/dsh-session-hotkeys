  ...
  factory: (require) => {
    ...
    const I18N = {
      zh: {
        ...
        "full.archiveSession": "把当前会话移入侧边栏归档区（可在归档区找回），不会删除会话",
      ...
      en: {
        ...
        "desc.navMode": "Nav mode: ↑↓ select · Enter open",
        ...
        "desc.archiveSession": "Archive the current session",
        ...
        "full.navMode": "Enter nav mode: ↑↓ moves the highlight over session rows, Enter opens (same as clicking), Esc or any other key exits; the highlight also lands on \"show more sessions\" buttons — Enter expands and jumps to the first new session",
        ...
        "full.archiveSession": "Move the current session into the sidebar archive (recoverable there); it is not deleted",
        ...
        "navExited": "Nav mode exited",
        "navLocating": "Nav mode: locating session rows…",
        "navStarted": "Nav mode · {n} targets · ↑↓ move, Enter to open",
    ...
    const KEY_SECTIONS = [
      ["secCommon", ["navMode", "switchDigit", "newSession", "panel"]],
        ...
        if (ui.open === true && ui.rect !== null) {
          ...
          children.push(React.createElement("div", {
            ...
            React.createElement("div", { className: "shk-tabs" },
              React.createElement("button", { className: "shk-tab" + (tab === "keys" ? " shk-tab-on" : ""), onClick: () => { setTab("keys"); setPickerFor(0); } }, t("keysTab")),
              React.createElement("button", { className: "shk-tab" + (tab === "pos" ? " shk-tab-on" : ""), onClick: () => { setTab("pos"); setPickerFor(0); } }, modsTabLabel("switchDigit")),
              React.createElement("button", { className: "shk-tab" + (tab === "pin" ? " shk-tab-on" : ""), onClick: () => { setTab("pin"); setPickerFor(0); } }, modsTabLabel("pinToggle"))
            ),
            ...
            tab === "pos" || tab === "pin" ? React.createElement("div", { className: "shk-hint" }, tab === "pos"
              ...
              : t("pinHint", { toggle: specText(bindingsValue.pinToggle), jump: specText(bindingsValue.jumpPin) })) : null,
